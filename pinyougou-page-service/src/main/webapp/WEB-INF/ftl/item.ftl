						...
						<div id="specification" class="summary-wrap clearfix">
							<#list specificationList as item>
								<dl>
									...
									<dd>
									<a href="javascript:;" 
									 class="{{isSelectSpecification('${item.attributeName}','${value}')?'selected':''}}"
									  ng-click="selectSpecification('${item.attributeName}','${value}')" >
						...
						<div class="summary-wrap">
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										<input autocomplete="off" type="text" value="1" minnum="1" class="itxt" ng-model="number" />
										<a  class="increment plus" ng-click="addNumber(1)" >+</a>
										<a  class="increment mins" ng-click="addNumber(-1)">-</a>
									</div>
								</div>
							</div>
							<div class="fl">
